...
declare module "react" {
    interface CSSProperties {
      "--delay"?: string; // Define your custom property here
    }
  }
...
function Background() {
  ...
  return (
    <div
      ref={containerRef}
      className="-z-1 absolute inset-0 flex  h-full w-full flex-row justify-between bg-gradient-to-t from-violet-200 to-violet-900"
    >
      <div
        style={{
          background:
            "radial-gradient(50% 50% at 50% 50%,#FFFFFFFF 0%,rgb(7,42,57) 50%,rgba(7,42,57,0) 100%)",
        }}
