...
export default function Comparison() {
  ...
  const criteria: ComparisonCriterion[] = [
    ...
    {
      id: "7",
      name: "Personnalisation de carte",
      paysikure: false,
      neero: true,
      category: "cartes",
    },
  ...
  return (
    <section className="py-8 sm:py-32 px-4 max-w-6xl mx-auto">
{/*       <div className="text-center mb-6 sm:mb-10">
      ...
      <Card className="border-0 shadow-lg">
        <CardHeader className="bg-gradient-to-r from-violet-500/10 via-blue-500/10 to-green-500/10 rounded-t-lg p-4 sm:p-6">
          <CardTitle className="text-xl font-bold sm:text-4xl text-center">
            PaySikure vs Neero
          </CardTitle>
                ...
                <table className="w-full border-collapse min-w-[600px]">
                  <thead>
                    <tr className="border-b">
                      <th className="text-left py-4 px-2 sm:px-4 font-medium text-gray-500">
                        Fonctionnalité
                      </th>
        ...
        <Card className="border-0 shadow-md overflow-hidden">
          ...
          <CardHeader className="p-4 sm:p-6">
            <CardTitle className="flex items-center text-lg sm:text-xl">
              <div className="h-6 w-6 sm:h-8 sm:w-8 rounded-full flex items-center justify-center mr-2">
                <Image
                  src="/images/logo.png"
                  alt="logo"
                  width={164}
          ...
          <CardContent className="p-4 sm:p-6 pt-0 sm:pt-0">
            <ul className="space-y-2 text-xs sm:text-sm">
              <li className="flex items-center">
                <Check className="h-4 w-4 sm:h-5 sm:w-5 text-green-600 mr-2 flex-shrink-0" />
                <span>
                  Options d&apos;épargne et d&apos;investissement avancées
                </span>
              </li>
              <li className="flex items-center">
                <Check className="h-4 w-4 sm:h-5 sm:w-5 text-green-600 mr-2 flex-shrink-0" />
