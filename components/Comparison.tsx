...
export default function Comparison() {
  ...
  const handleRowClick = (id: string) => {
    setSelectedCriterion(selectedCriterion === id ? null : id);
  };
              ...
              <table className=" w-full">
                <tbody>
                  <tr className="align-middle">
                    ...
                    <td className="w-1/2 pb-2  ">
                      <div className="flex items-center my-auto ">
                        <span className="text-sm sm:text-xl font-bold text-violet-700">
                          0 FCFA
                        </span>
                      </div>
                    </td>
      ...
      <div className="py-8 sm:py-16 flex flex-row justify-between mx-2 sm:mx-16 ">
        ...
        <div className="p-4 sm:p-2 border-0 shadow-lg overflow-hidden">
          <Tabs
            ...
            className="w-full "
          >
            <TabsList className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 mb-0 sm:mb-8 gap-0 overflow-x-auto">
                ...
                <table className="w-full border-collapse  min-w-[100px]">
                  <thead>
                    <tr className="border-b">
                      <th className="text-left text-lg py-4 px-2 sm:px-4 font-medium text-gray-500"></th>
                    ...
                    {filteredCriteria.map((criterion, index) => (
                      <>
                        <tr
                          ...
                          onClick={() => handleRowClick(criterion.id)}
                        >
                        ...
                        {selectedCriterion === criterion.id &&
                          criterion.description && (
                            <tr className="bg-gray-200">
                              <td
                                colSpan={3}
                                className="py-2 px-10 sm:px-10 font-light sm:font-normal text-sm sm:text-base text-black sm:text-gray-900  text-justify sm:text-start "
                              >
                                {criterion.description}
                              </td>
                            </tr>
